...
\begin{figure}
	\centering
	\mfig[1]{example_decomposition.png}
	\caption{(a) Result of numerical experiment. (b) Reflected field found from directional 
	spectrum. (c) Integrated energy transport.}
\end{figure}
...
\begin{figure}
	...
	numerical solution and spectrum obtained estimate. Here results for different fitting window 
	are given. (c) and (d) error in energy budget for incident (circles) and reflected (squares) 
	and for different antenna sizes. Left column is for straight incidence experiments and right 
