...
(the assumed model)Further, the model is assumed to consist of plane waves, so kernel function translating spectra into measurable quantities will consist of polarization relation.\\
